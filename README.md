...
> N от M филтър – нотификацията се изпраща, ако поне N от M филтри са изпълнени. Например: "Искам поне 2 от 3 да са изпълнени – [дизел, Ауди, след 2003]".
