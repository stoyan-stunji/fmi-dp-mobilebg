...
*Проблеми в настоящата имплементация:*

*- NotificationRule има списък от филтри, които трябва да бъдат изпълнени едновременно;*

*- Липсва механизъм за дефиниране на сложни логически връзки между филтрите;*

*- Клиентите изискват по-голяма гъвкавост, например възможност да зададат условия от типа "(БМВ, бензин, след 2010) ИЛИ (АУДИ, дизел, преди 2020)".*
