...
public class Main
{
    public static void main(String[] args)
    {
        ...
        Subscriber smsSubscriber = new SmsSubscriber(smsNotifier, "088 456 7890", "New Car For 10000!");
        Subscriber emailSubscriber = new EmailSubscriber(emailNotifier, "sustoyanivanov2@gmail.com", "New Deal!", "Camaro!!!");
        Subscriber pigeonSubscriber = new PigeonSubscriber(pigeonNotifier, "ul. Suhin Dol №10", "New Deal!", 1);
